...
_PDK_TECHLEF = "/pdk/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef"
...
def _build_power_tcl(
    ...
    sdc_section = f"read_sdc {sdc_linux}" if sdc_linux else "create_clock -name clk -period 10 [get_ports clk]"
    return f"""
